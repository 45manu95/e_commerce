...
import '../../../admin_area/category/select_category/select_category.dart';
import '../../product_list/products_area.dart';
    ...
    if (isValid) {
      ...
      Product()
          .addProduct(_id, _nome, _marca, _quantita, _descrizione, _prezzo,
              _categoria, _imagesByte, _images ,context)
          .then((value) {
        if (value == true) {
          setState(() {
            loadingAccess = true;
