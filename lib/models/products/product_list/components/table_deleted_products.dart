...
class TableDeleteProducts extends StatefulWidget {
  TableDeleteProducts(
  ...
  @override
  State<TableDeleteProducts> createState() => _TableDeleteProductsState();
}

class _TableDeleteProductsState extends State<TableDeleteProducts> {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder(
      future: Product().dataDeleteProducts(
        ...
        child: Container(
          ...
          child: Stack(children: [
            WebDataTable(
              ...
              actions: [
                if (_selectedRowKeys.isNotEmpty && widget.cfCliente == "")
                  SizedBox(
                    height: 50,
                    width: 125,
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        Product().recuperaProdottoEliminato(
                ...
                Container(
                  ...
                  child: TextField(
                    ...
                    onSubmitted: (value) {
                      widget.search = value;
                      Product().searchDeleteProduct(value, context);
                    },
                  ),
                ),
              ],
              source: WebDataTableSource(
                columns: [
                  ...
                  WebDataColumn(
                    ...
                    dataCell: (value) => DataCell(Text('${value['nome']}')),
                  ),
                ],
